function(AddCoverage target)
  ...
  add_custom_target(
    ...
    COMMAND
      ...
      ${SYSTEM_INCLUDE_PATH} --rc derive_function_end_line=0 --exclude
      ${CMAKE_SOURCE_DIR}/tests --gcov-tool ${GCOV_PATH} -c -i -o coverage.base
    # Run tests
    ...
    COMMAND
      ...
      ${GCOV_PATH} --capture -o coverage.info
    COMMAND ${LCOV_PATH} ${LCOV_ARGS} -d . -r coverage.info -o filtered.info
